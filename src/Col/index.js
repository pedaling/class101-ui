...
const Col = styled.div`
  ...
  ${media.sm`
    ...
    ${props => 
      props.smOffset && 
      css`margin-left: ${sizeToPercent(props.smOffset)}%;`}
  `}
  ...
  ${media.md`
    ...
    ${props => 
      ...
      css`margin-left: ${sizeToPercent(props.mdOffset || props.smOffset)}%;`}
  `}
  ...
  ${media.lg`
    ...
    ${props => 
      ...
      css`margin-left: ${sizeToPercent(props.lgOffset || props.mdOffset || props.smOffset)}%;`}
  `};
`;
