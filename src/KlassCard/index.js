...
import { orange600, red600, red000 } from '../Colors';
import { tiny1Gray, tiny1BlackBold } from '../TextStyles';
...
const ReservationButton = styled(Button).attrs({size: 'sm'})`
  ${tiny1Gray};
  width: 100%;
  margin-top: 8px;
...
const FILL_HEART_D="M5 16.5c-1.911-1.911-3.5-3.962-3.5-7A5.5 5.5 0 0 1 7 4c2.5 0 4 1.5 5 2.5 1-1 2.5-2.5 5-2.5a5.5 5.5 0 0 1 5.5 5.5c0 3.038-1.589 5.089-3.5 7-1.333 1.333-3.667 2.833-7 4.5-3.333-1.667-5.667-3.167-7-4.5z"
...
export default ({
  ...
  const creatorNameElement = (
    <CreatorName>by { creatorName }</CreatorName>
  );
  if (state === 'sale' || state === 'funding') {
    const subInforElement = (
      <SubInfo>
        ...
        {sale && [<Dot>・</Dot>,<Sale>{sale}% 할인</Sale>]}
      </SubInfo>
    );
    return (
      <KlassCard 
