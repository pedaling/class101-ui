...
export interface AnchorButtonProps extends ButtonCommonProps<ContainButtonColorValue, ContainButtonSizeValue> {
  fill: boolean;
}

export class AnchorButton extends PureComponent<AnchorButtonProps> {
  public static defaultProps: Partial<AnchorButtonProps> = {
    theme: Theme.light,
