import { Colors, HTMLDivProps, TextStyles } from '@common';
...
export class BottomSheet extends PureComponent<Props, State> {
...
const Chevron = styled(Icon.Chevron).attrs({ size: 24 })<{ rotate?: number }>`
  position: absolute;
  right: 24px;
