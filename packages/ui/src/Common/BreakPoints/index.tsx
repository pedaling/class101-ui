...
export const BreakPoints = {
  ...
  media: {
    sm: <T extends object>(
      ...
      const mediaQuery = buildMediaQuery(BreakPoints.SIZES.sm);
      return css<T>`
        @media ${mediaQuery} {
    ...
    md: <T extends object>(
      ...
      const mediaQuery = buildMediaQuery(BreakPoints.SIZES.md);
      return css<T>`
        @media ${mediaQuery} {
          ${css<T>(first, ...interpolations)};
        }
    ...
    lg: <T extends object>(
      ...
      const mediaQuery = buildMediaQuery(BreakPoints.SIZES.lg);
      return css<T>`
        @media ${mediaQuery} {
          ${css<T>(first, ...interpolations)};
        }
