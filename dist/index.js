...
var media = Object.keys(SIZES).reduce(function (acc, label) {
  acc[label] = function () {
    ...
    return styled.css(_templateObject, mediaQuery, styled.css.apply(undefined, arguments));
  };
  return acc;
}, {});
...
var heading1BlackBold = styled.css(_templateObject$1, gray800);

var heading2WhiteBold = styled.css(_templateObject2, white);

var heading1WhiteBold = styled.css(_templateObject3, white);

var body1Black = styled.css(_templateObject4, gray800);

var body2Black = styled.css(_templateObject5, gray800);

var body2White = styled.css(_templateObject5, white);

var body2Gray = styled.css(_templateObject5, gray500);

var tiny1WhiteBold = styled.css(_templateObject6, white);

var body1WhiteBold = styled.css(_templateObject7, white);

var body2BlackBold = styled.css(_templateObject8, gray800);

var subheadingBlackBold = styled.css(_templateObject9, gray800);

var tiny1Black = styled.css(_templateObject10, gray800);

var tiny2Black = styled.css(_templateObject11);

var tiny2White = styled.css(_templateObject12, white);

var body1Body = styled.css(_templateObject13, gray700);

var heading3BlackBold = styled.css(_templateObject14, gray800);

var tiny1Gray = styled.css(_templateObject15, gray500);

var heading2BlackExtraBold = styled.css(_templateObject16, gray800);

var tiny1White = styled.css(_templateObject10, white);

var heading3WhiteBold = styled.css(_templateObject14, white);

var body1Gray = styled.css(_templateObject4, gray500);

var body2WhiteBold = styled.css(_templateObject8, white);

var body1BlackBold = styled.css(_templateObject7, gray800);

var subheadingGray = styled.css(_templateObject17, gray500);

var tiny2Gray = styled.css(_templateObject18, gray500);

var heading1BlackExtraBold = styled.css(_templateObject19, gray800);

var heading3BlackExtraBold = styled.css(_templateObject20, gray800);

var subheadingWhiteBold = styled.css(_templateObject9, white);

var tiny1BlackBold = styled.css(_templateObject21, gray800);

var body1White = styled.css(_templateObject4, white);

var body1Paragraph = styled.css(_templateObject22, gray600);

var body2Body = styled.css(_templateObject23, gray800);

var body2Paragraph = styled.css(_templateObject24, gray700);

var heading3WhiteExtraBold = styled.css(_templateObject20, white);

var heading2BlackBold = styled.css(_templateObject2, gray800);

var tiny2WhiteBold = styled.css(_templateObject25, white);

var heading1WhiteExtraBold = styled.css(_templateObject19, white);

var body2GrayBold = styled.css(_templateObject8, gray500);

var heading3GrayBold = styled.css(_templateObject14, gray500);

var subheadingBlack = styled.css(_templateObject17, gray700);
...
var Grid = styled__default.div(_templateObject$2, media.sm(_templateObject2$1), media.lg(_templateObject3$1, function (props) {
...
var Col = styled__default.div(_templateObject$3, function (props) {
...
var Row = styled__default.div.attrs({ className: 'clearfix' })(_templateObject$4, media.sm(_templateObject2$3));
...
var SpinnerHead = styled__default.path(_templateObject$5, function (props) {
  return props.backgroundColor || gray600;
});

var SpinnerTrack = styled__default.path(_templateObject2$4, function (props) {
  return props.color || gray200;
});

var Container = styled__default.div(_templateObject3$3);
...
var Bar = styled__default.div(_templateObject$6, function (props) {
  return props.barColor || orange600;
}, function (props) {
  return props.percent || 0;
});

var Container$1 = styled__default.div(_templateObject2$5, function (props) {
  return props.backgroundColor || gray700;
}, function (props) {
  return props.height && styled.css(_templateObject3$4, props.height, Bar, props.height);
});
...
exports.BreakPoints = index$1;
exports.TextStyles = index$2;
exports.Grid = Grid;
exports.Col = Col;
exports.Row = Row;
exports.Spinner = index$3;
exports.ProgressBar = index$4;
